...
quarkpy.mapsearch.items.append(quarkpy.qmenu.item('Find &Non-integral Faces', findNonIntegralFaces,
...
quarkpy.mapcommands.items.append(quarkpy.qmenu.item('Integralize Selected Faces', integralizeFaces,
